...
func (x *UpdateProblemGroupRequest) Reset() {
	*x = UpdateProblemGroupRequest{}
...
func (x *UpdateProblemGroupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateProblemGroupRequest) ProtoMessage() {}

func (x *UpdateProblemGroupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_problempb_service_proto_msgTypes[0]
...
// Deprecated: Use UpdateProblemGroupRequest.ProtoReflect.Descriptor instead.
func (*UpdateProblemGroupRequest) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{0}
}

func (x *UpdateProblemGroupRequest) GetRawProblemId() uint64 {
	if x != nil {
...
func (x *UpdateProblemGroupRequest) GetGroupId() uint64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
type UpdateProblemGroupResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateProblemGroupResponse) Reset() {
	*x = UpdateProblemGroupResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateProblemGroupResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateProblemGroupResponse) ProtoMessage() {}

func (x *UpdateProblemGroupResponse) ProtoReflect() protoreflect.Message {
	mi := &file_problempb_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateProblemGroupResponse.ProtoReflect.Descriptor instead.
func (*UpdateProblemGroupResponse) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{1}
}

func (x *UpdateProblemGroupResponse) GetBaseResponse() *base.BaseResponse {
	if x != nil {
...
func (x *RawProblemListRequest) Reset() {
	*x = RawProblemListRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RawProblemListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawProblemListRequest) ProtoMessage() {}

func (x *RawProblemListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_problempb_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawProblemListRequest.ProtoReflect.Descriptor instead.
func (*RawProblemListRequest) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{2}
}

func (x *RawProblemListRequest) GetPageNo() int32 {
	if x != nil {
		return x.PageNo
	}
	return 0
...
func (x *RawProblemListRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type RawProblemListResponse struct {
	...
	RawProblems  []*RawProblem      `protobuf:"bytes,1,rep,name=raw_problems,json=rawProblems,proto3" json:"raw_problems,omitempty"`
...
func (x *RawProblemListResponse) Reset() {
	*x = RawProblemListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RawProblemListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawProblemListResponse) ProtoMessage() {}

func (x *RawProblemListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_problempb_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawProblemListResponse.ProtoReflect.Descriptor instead.
func (*RawProblemListResponse) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{3}
}

func (x *RawProblemListResponse) GetRawProblems() []*RawProblem {
	if x != nil {
		return x.RawProblems
	}
	return nil
}

func (x *RawProblemListResponse) GetTotalPages() int32 {
	if x != nil {
		return x.TotalPages
	}
	return 0
...
func (x *RawProblemListResponse) GetTotalCount() int32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *RawProblemListResponse) GetBaseResponse() *base.BaseResponse {
	if x != nil {
		return x.BaseResponse
	}
	return nil
...
func (x *GetContestAdminsRequest) Reset() {
	*x = GetContestAdminsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_problempb_service_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetContestAdminsRequest) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{40}
}
...
func (x *GetContestAdminsResponse) Reset() {
	*x = GetContestAdminsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_problempb_service_proto_msgTypes[41]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetContestAdminsResponse) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{41}
}
...
func (x *GetContestParticipantsRequest) Reset() {
	*x = GetContestParticipantsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_problempb_service_proto_msgTypes[42]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetContestParticipantsRequest) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{42}
}
...
func (x *GetContestParticipantsResponse) Reset() {
	*x = GetContestParticipantsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_problempb_service_proto_msgTypes[43]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetContestParticipantsResponse) Descriptor() ([]byte, []int) {
	return file_problempb_service_proto_rawDescGZIP(), []int{43}
}
...
var file_problempb_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x1b, 0x70, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x70, 0x62, 0x2f, 0x72, 0x61,
	0x77, 0x5f, 0x70, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x19, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62, 0x2f,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5c, 0x0a, 0x19, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	0x0c, 0x72, 0x61, 0x77, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x49, 0x64, 0x12, 0x19, 0x0a,
	0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x22, 0x55, 0x0a, 0x1a, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65,
	...
	0x4d, 0x0a, 0x15, 0x52, 0x61, 0x77, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x4c, 0x69, 0x73,
	...
	0x01, 0x0a, 0x16, 0x52, 0x61, 0x77, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x0c, 0x72, 0x61, 0x77,
	0x5f, 0x70, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0f, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x52, 0x61, 0x77, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d,
	0x52, 0x0b, 0x72, 0x61, 0x77, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x73, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x0c, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x67, 0x0a,
	...
	0x73, 0x65, 0x32, 0x83, 0x0f, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x53, 0x65,
	...
	,
...
var file_problempb_service_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_problempb_service_proto_goTypes = []interface{}{
	(*UpdateProblemGroupRequest)(nil),           // 0: sdk.UpdateProblemGroupRequest
	(*UpdateProblemGroupResponse)(nil),          // 1: sdk.UpdateProblemGroupResponse
	(*RawProblemListRequest)(nil),               // 2: sdk.RawProblemListRequest
	(*RawProblemListResponse)(nil),              // 3: sdk.RawProblemListResponse
	(*RandProblemRequest)(nil),                  // 4: sdk.RandProblemRequest
	(*RandProblemResponse)(nil),                 // 5: sdk.RandProblemResponse
	(*GetUserContestsRequest)(nil),              // 6: sdk.GetUserContestsRequest
	(*GetUserContestsResponse)(nil),             // 7: sdk.GetUserContestsResponse
	(*GetContestProblemsRequest)(nil),           // 8: sdk.GetContestProblemsRequest
	(*GetContestProblemsResponse)(nil),          // 9: sdk.GetContestProblemsResponse
	(*UpdateContestProblemsRequest)(nil),        // 10: sdk.UpdateContestProblemsRequest
	(*UpdateContestProblemsResponse)(nil),       // 11: sdk.UpdateContestProblemsResponse
	(*UpdateContestRequest)(nil),                // 12: sdk.UpdateContestRequest
	(*UpdateContestResponse)(nil),               // 13: sdk.UpdateContestResponse
	(*AddContestProblemRequest)(nil),            // 14: sdk.AddContestProblemRequest
	(*AddContestProblemResponse)(nil),           // 15: sdk.AddContestProblemResponse
	(*DeleteContestProblemRequest)(nil),         // 16: sdk.DeleteContestProblemRequest
	(*DeleteContestProblemResponse)(nil),        // 17: sdk.DeleteContestProblemResponse
	(*DeleteContestAdminRequest)(nil),           // 18: sdk.DeleteContestAdminRequest
	(*DeleteContestAdminResponse)(nil),          // 19: sdk.DeleteContestAdminResponse
	(*ListProblemsRequest)(nil),                 // 20: sdk.ListProblemsRequest
	(*ListProblemsResponse)(nil),                // 21: sdk.ListProblemsResponse
	(*GetProblemByIdRequest)(nil),               // 22: sdk.GetProblemByIdRequest
	(*GetProblemByIdResponse)(nil),              // 23: sdk.GetProblemByIdResponse
	(*SearchProblemByConditionRequest)(nil),     // 24: sdk.SearchProblemByConditionRequest
	(*SearchProblemByConditionResponse)(nil),    // 25: sdk.SearchProblemByConditionResponse
	(*CreateContestRequest)(nil),                // 26: sdk.CreateContestRequest
	(*CreateContestResponse)(nil),               // 27: sdk.CreateContestResponse
	(*ListContestsRequest)(nil),                 // 28: sdk.ListContestsRequest
	(*ListContestsResponse)(nil),                // 29: sdk.ListContestsResponse
	(*SearchContestByConditionRequest)(nil),     // 30: sdk.SearchContestByConditionRequest
	(*SearchContestByConditionResponse)(nil),    // 31: sdk.SearchContestByConditionResponse
	(*GetContestByIdRequest)(nil),               // 32: sdk.GetContestByIdRequest
	(*GetContestByIdResponse)(nil),              // 33: sdk.GetContestByIdResponse
	(*AddContestParticipantRequest)(nil),        // 34: sdk.AddContestParticipantRequest
	(*AddContestParticipantResponse)(nil),       // 35: sdk.AddContestParticipantResponse
	(*GenerateContestParticipantsRequest)(nil),  // 36: sdk.GenerateContestParticipantsRequest
	(*GenerateContestParticipantsResponse)(nil), // 37: sdk.GenerateContestParticipantsResponse
	(*AddContestAdminRequest)(nil),              // 38: sdk.AddContestAdminRequest
	(*AddContestAdminResponse)(nil),             // 39: sdk.AddContestAdminResponse
	(*GetContestAdminsRequest)(nil),             // 40: sdk.GetContestAdminsRequest
	(*GetContestAdminsResponse)(nil),            // 41: sdk.GetContestAdminsResponse
	(*GetContestParticipantsRequest)(nil),       // 42: sdk.GetContestParticipantsRequest
	(*GetContestParticipantsResponse)(nil),      // 43: sdk.GetContestParticipantsResponse
	(*base.BaseResponse)(nil),                   // 44: base.BaseResponse
	(*RawProblem)(nil),                          // 45: sdk.RawProblem
	(*Contest)(nil),                             // 46: sdk.Contest
	(*ContestProblem)(nil),                      // 47: sdk.ContestProblem
	(*Problem)(nil),                             // 48: sdk.Problem
	(*userpb.User)(nil),                         // 49: sdk.User
}
var file_problempb_service_proto_depIdxs = []int32{
	44, // 0: sdk.UpdateProblemGroupResponse.base_response:type_name -> base.BaseResponse
	45, // 1: sdk.RawProblemListResponse.raw_problems:type_name -> sdk.RawProblem
	44, // 2: sdk.RawProblemListResponse.base_response:type_name -> base.BaseResponse
	44, // 3: sdk.RandProblemResponse.base_response:type_name -> base.BaseResponse
	46, // 4: sdk.GetUserContestsResponse.contests:type_name -> sdk.Contest
	44, // 5: sdk.GetUserContestsResponse.base_response:type_name -> base.BaseResponse
	47, // 6: sdk.GetContestProblemsResponse.contest_problems:type_name -> sdk.ContestProblem
	44, // 7: sdk.GetContestProblemsResponse.base_response:type_name -> base.BaseResponse
	47, // 8: sdk.UpdateContestProblemsRequest.contest_problems:type_name -> sdk.ContestProblem
	47, // 9: sdk.UpdateContestProblemsResponse.contest_problems:type_name -> sdk.ContestProblem
	44, // 10: sdk.UpdateContestProblemsResponse.base_response:type_name -> base.BaseResponse
	46, // 11: sdk.UpdateContestRequest.contest:type_name -> sdk.Contest
	46, // 12: sdk.UpdateContestResponse.contest:type_name -> sdk.Contest
	44, // 13: sdk.UpdateContestResponse.base_response:type_name -> base.BaseResponse
	44, // 14: sdk.AddContestProblemResponse.base_response:type_name -> base.BaseResponse
	44, // 15: sdk.DeleteContestProblemResponse.base_response:type_name -> base.BaseResponse
	44, // 16: sdk.DeleteContestAdminResponse.base_response:type_name -> base.BaseResponse
	48, // 17: sdk.ListProblemsResponse.problems:type_name -> sdk.Problem
	44, // 18: sdk.ListProblemsResponse.base_response:type_name -> base.BaseResponse
	48, // 19: sdk.GetProblemByIdResponse.problem:type_name -> sdk.Problem
	44, // 20: sdk.GetProblemByIdResponse.base_response:type_name -> base.BaseResponse
	48, // 21: sdk.SearchProblemByConditionResponse.problems:type_name -> sdk.Problem
	44, // 22: sdk.SearchProblemByConditionResponse.base_response:type_name -> base.BaseResponse
	46, // 23: sdk.CreateContestRequest.contest:type_name -> sdk.Contest
	47, // 24: sdk.CreateContestRequest.contest_problems:type_name -> sdk.ContestProblem
	46, // 25: sdk.CreateContestResponse.contest:type_name -> sdk.Contest
	44, // 26: sdk.CreateContestResponse.base_response:type_name -> base.BaseResponse
	46, // 27: sdk.ListContestsResponse.contests:type_name -> sdk.Contest
	44, // 28: sdk.ListContestsResponse.base_response:type_name -> base.BaseResponse
	46, // 29: sdk.SearchContestByConditionResponse.contests:type_name -> sdk.Contest
	44, // 30: sdk.SearchContestByConditionResponse.base_response:type_name -> base.BaseResponse
	46, // 31: sdk.GetContestByIdResponse.contest:type_name -> sdk.Contest
	44, // 32: sdk.GetContestByIdResponse.base_response:type_name -> base.BaseResponse
	44, // 33: sdk.AddContestParticipantResponse.base_response:type_name -> base.BaseResponse
	49, // 34: sdk.GenerateContestParticipantsResponse.users:type_name -> sdk.User
	44, // 35: sdk.GenerateContestParticipantsResponse.base_response:type_name -> base.BaseResponse
	44, // 36: sdk.AddContestAdminResponse.base_response:type_name -> base.BaseResponse
	49, // 37: sdk.GetContestAdminsResponse.users:type_name -> sdk.User
	44, // 38: sdk.GetContestAdminsResponse.base_response:type_name -> base.BaseResponse
	49, // 39: sdk.GetContestParticipantsResponse.users:type_name -> sdk.User
	44, // 40: sdk.GetContestParticipantsResponse.base_response:type_name -> base.BaseResponse
	20, // 41: sdk.ProblemService.ListProblems:input_type -> sdk.ListProblemsRequest
	22, // 42: sdk.ProblemService.GetProblemById:input_type -> sdk.GetProblemByIdRequest
	24, // 43: sdk.ProblemService.SearchProblemByCondition:input_type -> sdk.SearchProblemByConditionRequest
	26, // 44: sdk.ProblemService.CreateContest:input_type -> sdk.CreateContestRequest
	28, // 45: sdk.ProblemService.ListContests:input_type -> sdk.ListContestsRequest
	30, // 46: sdk.ProblemService.SearchContestByCondition:input_type -> sdk.SearchContestByConditionRequest
	32, // 47: sdk.ProblemService.GetContestById:input_type -> sdk.GetContestByIdRequest
	34, // 48: sdk.ProblemService.AddContestParticipant:input_type -> sdk.AddContestParticipantRequest
	36, // 49: sdk.ProblemService.GenerateContestParticipants:input_type -> sdk.GenerateContestParticipantsRequest
	38, // 50: sdk.ProblemService.AddContestAdmin:input_type -> sdk.AddContestAdminRequest
	40, // 51: sdk.ProblemService.GetContestAdmins:input_type -> sdk.GetContestAdminsRequest
	42, // 52: sdk.ProblemService.GetContestParticipants:input_type -> sdk.GetContestParticipantsRequest
	14, // 53: sdk.ProblemService.AddContestProblem:input_type -> sdk.AddContestProblemRequest
	16, // 54: sdk.ProblemService.DeleteContestProblem:input_type -> sdk.DeleteContestProblemRequest
	18, // 55: sdk.ProblemService.DeleteContestAdmin:input_type -> sdk.DeleteContestAdminRequest
	12, // 56: sdk.ProblemService.UpdateContest:input_type -> sdk.UpdateContestRequest
	10, // 57: sdk.ProblemService.UpdateContestProblems:input_type -> sdk.UpdateContestProblemsRequest
	8,  // 58: sdk.ProblemService.GetContestProblems:input_type -> sdk.GetContestProblemsRequest
	6,  // 59: sdk.ProblemService.GetUserContests:input_type -> sdk.GetUserContestsRequest
	4,  // 60: sdk.ProblemService.RandProblem:input_type -> sdk.RandProblemRequest
	2,  // 61: sdk.ProblemService.RawProblemList:input_type -> sdk.RawProblemListRequest
	0,  // 62: sdk.ProblemService.UpdateProblemGroup:input_type -> sdk.UpdateProblemGroupRequest
	21, // 63: sdk.ProblemService.ListProblems:output_type -> sdk.ListProblemsResponse
	23, // 64: sdk.ProblemService.GetProblemById:output_type -> sdk.GetProblemByIdResponse
	25, // 65: sdk.ProblemService.SearchProblemByCondition:output_type -> sdk.SearchProblemByConditionResponse
	27, // 66: sdk.ProblemService.CreateContest:output_type -> sdk.CreateContestResponse
	29, // 67: sdk.ProblemService.ListContests:output_type -> sdk.ListContestsResponse
	31, // 68: sdk.ProblemService.SearchContestByCondition:output_type -> sdk.SearchContestByConditionResponse
	33, // 69: sdk.ProblemService.GetContestById:output_type -> sdk.GetContestByIdResponse
	35, // 70: sdk.ProblemService.AddContestParticipant:output_type -> sdk.AddContestParticipantResponse
	37, // 71: sdk.ProblemService.GenerateContestParticipants:output_type -> sdk.GenerateContestParticipantsResponse
	39, // 72: sdk.ProblemService.AddContestAdmin:output_type -> sdk.AddContestAdminResponse
	41, // 73: sdk.ProblemService.GetContestAdmins:output_type -> sdk.GetContestAdminsResponse
	43, // 74: sdk.ProblemService.GetContestParticipants:output_type -> sdk.GetContestParticipantsResponse
	15, // 75: sdk.ProblemService.AddContestProblem:output_type -> sdk.AddContestProblemResponse
	17, // 76: sdk.ProblemService.DeleteContestProblem:output_type -> sdk.DeleteContestProblemResponse
	19, // 77: sdk.ProblemService.DeleteContestAdmin:output_type -> sdk.DeleteContestAdminResponse
	13, // 78: sdk.ProblemService.UpdateContest:output_type -> sdk.UpdateContestResponse
	11, // 79: sdk.ProblemService.UpdateContestProblems:output_type -> sdk.UpdateContestProblemsResponse
	9,  // 80: sdk.ProblemService.GetContestProblems:output_type -> sdk.GetContestProblemsResponse
	7,  // 81: sdk.ProblemService.GetUserContests:output_type -> sdk.GetUserContestsResponse
	5,  // 82: sdk.ProblemService.RandProblem:output_type -> sdk.RandProblemResponse
	3,  // 83: sdk.ProblemService.RawProblemList:output_type -> sdk.RawProblemListResponse
	1,  // 84: sdk.ProblemService.UpdateProblemGroup:output_type -> sdk.UpdateProblemGroupResponse
...
func file_problempb_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_problempb_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateProblemGroupResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_problempb_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RawProblemListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_problempb_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RawProblemListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_problempb_service_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
		...
		file_problempb_service_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
		...
		file_problempb_service_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
		...
		file_problempb_service_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
